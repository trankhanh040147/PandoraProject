			...
			<div class="app-sidebar sidebar-shadow">
				...
				<div class="scrollbar-sidebar">
					<div class="app-sidebar__inner">
						<div><a href="${pageContext.request.contextPath}/admin/home">
							<div class="app-sidebar__heading" style:>Admin</div></a>
						</div>
						<ul class="vertical-nav-menu">
							<li class="app-sidebar__heading">Quản lý</li>
							<li><a href="${pageContext.request.contextPath}/admin/manageUser"> <i
									class="metismenu-icon pe-7s-config"></i> Quản lý người dùng
							</a></li>
							<li><a href="index.html"> <i
									class="metismenu-icon pe-7s-config"></i> Quản lý cửa hàng
							</a></li>
							<li><a href="index.html"> <i
									class="metismenu-icon pe-7s-config"></i> Quản lý sản phẩm
							</a></li>
							<li><a href="index.html"> <i
									class="metismenu-icon pe-7s-config"></i> Quản lý đơn hàng
							</a></li>
							<li><a href="index.html"> <i
									class="metismenu-icon pe-7s-config"></i> Quản lý loại sản phẩm
							</a></li>
							<li><a href="index.html"> <i
									class="metismenu-icon pe-7s-config"></i> Quản lý thuộc tính loại sản phẩm
							</a></li>
							<li><a href="index.html"> <i
									class="metismenu-icon pe-7s-config"></i> Quản lý đơn vị vận chuyển
							</a></li>
							<li><a href="index.html"> <i
									class="metismenu-icon pe-7s-config"></i> Quản lý giao dịch
							</a></li>
							<li class="app-sidebar__heading">Thống kê</li>
							<li><a href="index.html"> <i
									class="metismenu-icon pe-7s-graph1"></i> Thống kê doanh thu
							</a></li>
							<li><a href="index.html"> <i
									class="metismenu-icon pe-7s-graph1"></i> Thống kê người dùng mới
							</a></li>
							<li><a href="index.html"> <i
									class="metismenu-icon pe-7s-graph1"></i> Thống kê cửa hàng mới
							</a></li>
							<li>
