...
<section class="bg-img1 txt-center p-lr-15 p-tb-92"
	style="background-image: url('${dir}images/bg-01.jpg');">
	...
	<div class="container">
		<div class="row p-b-148">
			<div class="col-md-7 col-lg-8">
				<div class="p-t-7 p-r-85 p-r-15-lg p-r-0-md">
					...
					<p class="stext-113 cl6 p-b-26">Lorem ipsum dolor sit amet,
						...
						malesuada fames ac turpis egestas. Maecenas gravida justo eu arcu
						egestas convallis. Nullam eu erat bibendum, tempus ipsum eget,
						...
						euismod tortor, eget facilisis diam faucibus et. Morbi a tempor
						elit.</p>
			...
			<div class="col-11 col-md-5 col-lg-4 m-lr-auto">
				<div class="how-bor1 ">
					<div class="hov-img0">
						<img src="${dir}images/about-01.jpg" alt="IMG">
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row">
			...
			<div class="order-md-1 col-11 col-md-5 col-lg-4 m-lr-auto p-b-30">
				<div class="how-bor2">
					<div class="hov-img0">
						<img src="${dir}images/about-02.jpg" alt="IMG">
					</div>
				</div>
			</div>
		</div>
