	...
	<header class="header-v4">
		...
		<div class="container-menu-desktop">
			...
			<div class="wrap-menu-desktop how-shadow1">
				<nav class="limiter-menu-desktop container">
					...
					<!-- Logo desktop -->
					<a href="#" class="logo"> <img src="${dir}/images/icons/logo-01.png"
						alt="IMG-LOGO">
					</a>
					...
					<div class="wrap-icon-header flex-w flex-r-m">
						...
						<a href="<c:url value="/login"/>"
							...
							<h5 style="display: inline-block;">Đăng nhập</h5>
						</a>
					</div>
				</nav>
			</div>
		...
		<div class="wrap-header-mobile">
			...
			<div class="logo-mobile">
				<a href="index.html"><img src="${dir}/images/icons/logo-01.png"
					alt="IMG-LOGO"></a>
			</div>
		...
		<div
			...
			<div class="container-search-header">
				<button
					...
					<img src="${dir}/images/icons/icon-close2.png" alt="CLOSE">
				</button>
